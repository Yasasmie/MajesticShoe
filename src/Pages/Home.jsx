...
const SERVICES = [
  {
    ...
    desc: "Individually patterned classics crafted for your unique style.",
  },
  {
    icon: <Activity size={24} />,
    title: "Medical Solutions",
    desc: "Specialized footwear for diabetes and postural correction.",
  },
  {
    icon: <Ruler size={24} />,
    title: "Professional Fitting",
    desc: "Gait analysis ensures weight distribution is balanced.",
  },
  {
    icon: <ShieldCheck size={24} />,
    title: "Premium Leather",
    desc: "Sustainably sourced full-grain leathers that age beautifully.",
  },
  {
    icon: <Hammer size={24} />,
    title: "Master Craft",
    desc: "Old-world techniques combined with modern foot-health tech.",
  },
  {
    icon: <Sparkles size={24} />,
    title: "Restoration",
    desc: "Extend the life of your favorites with our resoling service.",
  },
];
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 pb-20 pt-32 lg:flex lg:items-center lg:gap-12 lg:pt-48 min-h-[90vh]">
        <section className="flex-1 space-y-8">
          ...
          <h1 className="text-5xl md:text-8xl font-light leading-[1] tracking-tighter text-white">
            Engineering <br />
            <span className="font-serif italic text-red-600 drop-shadow-[0_0_15px_rgba(220,38,38,0.3)]">
              Ultimate Comfort.
            </span>
          </h1>

          <p className="max-w-lg text-base md:text-lg leading-relaxed text-neutral-400">
            We fuse <span className="text-white">Sri Lankan artistry</span> with
            orthopedic precision. Experience footwear designed not just to be
            worn, but to be lived in.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            >
              Start Your Journey
              <MoveRight
                className="absolute right-4 opacity-0 transition-all group-hover:opacity-100"
                size={18}
              />
            </button>
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            {SERVICES.map((s, i) => {
              ...
              return (
                  ...
                  className={`absolute w-full max-w-sm transition-all duration-700 ease-out p-6
                    ${
                      isActive
                        ...
                        : "z-10 opacity-0 scale-90"
                    }
                    ${
                      offset === 1
                        ? "translate-x-[60%] md:translate-x-[80%] opacity-40 blur-sm z-20 !block"
                        : ""
                    }
                    ${
                      offset === -1
                ...
                >
                  <div
                    className={`rounded-[2.5rem] p-10 border transition-all duration-500 bg-[#0A0A0A]
                      ${
                        isActive
                          ? "border-red-600 shadow-[0_20px_50px_-10px_rgba(220,38,38,0.2)]"
                          : "border-white/5"
                      }
                    `}
                  >
                    <div
                      className={`mb-6 flex h-16 w-16 items-center justify-center rounded-2xl transition-colors duration-500
                        ${
                          isActive
                            ? "bg-red-600 text-white"
                            : "bg-white/5 text-red-600"
                        }
                      `}
                    >
                      {s.icon}
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-24 relative">
            ...
            <Step
              ...
              text="We discuss your lifestyle, health needs, and aesthetic preferences."
            />
            <Step
              num="02"
              title="Anatomical Mapping"
              text="Using traditional measurements and modern mapping, we create a custom last."
            />
            <Step
              num="03"
              title="Master Construction"
              text="Weeks of hand-cutting and stitching by master artisans in Kegalle."
            />
            <Step
              num="04"
              title="The Final Refinement"
              text="A trial fitting ensures every curve aligns with your stride."
            />
          </div>
        </div>
      </section>
      ...
      <section className="pb-32 px-6">
        <div className="mx-auto max-w-5xl rounded-[3rem] bg-gradient-to-br from-red-600 to-red-900 p-12 md:p-20 text-center relative overflow-hidden group">
          <div className="relative z-10">
            <h2 className="text-4xl md:text-6xl font-light text-white tracking-tighter mb-8">
  ...
  return (
    <div className="group relative flex flex-col md:flex-row gap-6 md:gap-16">
      ...
      <div className="space-y-2">
        <h4 className="text-2xl font-bold text-white tracking-tight group-hover:text-red-500 transition-colors">
          {title}
        </h4>
        <p className="max-w-xl text-neutral-400 leading-relaxed text-sm md:text-base">
          {text}
        </p>
      </div>
    </div>
