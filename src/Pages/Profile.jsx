...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-red-600/30">
      ...
      <main className="px-6 py-24 max-w-5xl mx-auto space-y-12">
        {showThankYou && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          <aside className="lg:col-span-1 space-y-6 sticky top-24">
            <section className="rounded-3xl border border-white/5 bg-[#0A0A0A] p-8 shadow-2xl overflow-hidden relative group">
              ...
              <h1 className="text-3xl font-bold tracking-tight text-white font-serif italic mb-6">
                Profile
              </h1>
              ...
              <button
                ...
                className="w-full mt-8 py-3 rounded-xl border border-white/10 text-[10px] font-black uppercase tracking-widest hover:bg-white/5 transition-colors"
              >
                Change Password
              </button>
            </section>
            ...
            {ordersLoading ? (
              ...
              <div className="space-y-6">
                {orders.map((order) => (
                  <div
                    key={order.id}
                    className="group border border-white/5 rounded-3xl p-6 bg-[#0A0A0A] hover:border-white/10 transition-all duration-500"
                  >
                      ...
                      {order.items?.map((item, idx) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-[10px] text-neutral-500 font-mono">
                              {item.quantity}x
                            </div>
                            <div>
                    ...
                    <div className="flex justify-between items-center pt-6 border-t border-white/5">
                      ...
                      <div className="text-xl font-bold text-white tracking-tighter">
                        <span className="text-[10px] font-normal text-neutral-500 mr-2 uppercase tracking-widest">
                          Total
                        </span>
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/90 backdrop-blur-sm">
          <div className="w-full max-w-md bg-[#0D0D0D] border border-white/10 rounded-3xl p-8 shadow-2xl animate-in zoom-in-95 duration-300">
